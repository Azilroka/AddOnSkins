...
local function LoadSkin()
	...
	-- skin tabs
	for i= 1, 2 do
		cSkinTab(_G["MerchantFrameTab"..i])
	end
	...
	MerchantBuyBackItemItemButtonIconTexture:SetTexCoord(unpack(c.TexCoords))
	...
	cSkinCloseButton(MerchantFrameCloseButton, MerchantFrame.backdrop)
	cSkinNextPrevButton(MerchantNextPageButton)
	cSkinNextPrevButton(MerchantPrevPageButton)
	cSkinButton(MerchantFrameFilterButton)
	cSkinButton(MerchantFrameSellJunkButton)
end
