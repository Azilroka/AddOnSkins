...
local function SkinBigBrother(self)
	...
	BigBrother_BuffWindow.LeftButton:FontString("text", E["media"].normfont, 12, "OUTLINE")
	...
	BigBrother_BuffWindow.RightButton:FontString("text", E["media"].normfont, 12, "OUTLINE")
