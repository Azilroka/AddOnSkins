...
local function SkinPowerAuras(self)
	...
	S:HandleButton(PowaBarAuraCoordASliderMinus)
	S:HandleButton(PowaBarAuraCoordASliderPlus)
	...
	S:HandleButton(PowaStacksCoordASliderMinus)
	S:HandleButton(PowaStacksCoordASliderPlus)
	...
	S:HandleSliderFrame(PowaBarAuraCoordASlider)
	...
	S:HandleSliderFrame(PowaTimerCoordASlider)
	...
	S:HandleSliderFrame(PowaStacksCoordASlider)
