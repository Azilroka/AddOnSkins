...
if IsAddOnLoaded("Altoholic") then 
	...
	if IsAddOnLoaded("Tukui") then s.SkinFuncs["Altoholic_Achievements"] = LoadSkin end
	if (IsAddOnLoaded("ElvUI") then c:GetModule('Skins') s:RegisterSkin('Altoholic_Achievements', LoadSkin) end
	end)
end