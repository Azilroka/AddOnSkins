...
function AS:UpdateMedia()
	...
	AS.BackdropColor = TukuiConfigNotShared['General']['BackdropColor']
	AS.BorderColor = TukuiConfigNotShared['General']['BorderColor']
end
...
function AS:EmbedSystem_WindowResize()
	...
	if Enhanced_Config[1].Options.args.addonskins then
