...
function AS:Blizzard_PetStable()
	...
	_G.PetStableModelRotateLeftButton:Point('TOPLEFT', 2, -2)
	AS:SkinArrowButton(_G.PetStableModelRotateLeftButton)
	_G.PetStableModelRotateRightButton:Point('TOPLEFT', _G.PetStableModelRotateLeftButton, 'TOPRIGHT', 3, 0)

	AS:CreateBackdrop(PetStablePetInfo)
	PetStablePetInfo:Point('TOPLEFT', 3, -22)
