...
function AS:Blizzard_WorldStateCaptureBar(event, addon)
	local Horde = [[Interface\AddOns\AddOnSkins_Tukui\Media\Icons\Gloss-Horde]]
	local Alliance = [[Interface\AddOns\AddOnSkins_Tukui\Media\Icons\Gloss-Alliance]]
	local FFA = [[Interface\AddOns\AddOnSkins_Tukui\Media\Icons\FFA]]
